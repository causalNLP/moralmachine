...
ggplot() + 
  ...
  geom_col(aes(y=data$gpt4_acme, x=as.numeric(as.factor(data$criterion1))), fill="#00557b", width = .3, alpha = 1) +
...
ggsave("fig_bar_pref2a.png", device=png, width = 27, height = 10, dpi=800)
