...
class MultiTranslator:
    deepl_lang = ["it", "es", "fr", "de", "pt", "pl", "nl", "sv", "no", "fi", "da", "el", "cs", "hu", "bg", "ro",
                  "en-us"]
    google_lang = ['ja', 'mk', 'bn', 'sk', 'ms', 'vi', 'sl', 'ar', 'ur', 'is', 'et', 'am', 'hr', 'bs', 'af', 'ka',
                   'ko', 'tr', 'id', 'sr', 'lv', 'hi', 'sw', 'th', 'fa', 'ru', 'uk', 'mt', 'lt', 'he', 'zh', 'sq',
                   'hy', 'az', 'be', 'km', 'kk', 'si', 'lb', 'mn', 'ne', 'tl', 'zu']
    google_lang = google_lang + deepl_lang
    def __init__(self):
        ...
        #import libraries and set environment variables only if needed
            ...
            os.system("pip install google-cloud google-cloud-translate==2.0.1")
